...
/**
 * Nadine Ineza and Sharon Ajayi (COSC 2354) A simple server thread. This class
 * performs the commands the client (Echo Client) sends to the server
 * (EchoSever)
 *
 */
public class EchoThread extends Thread implements Serializable {
     ...
     * Message sent by socket and executes the command if it can or prints out
     * the message received to the client.
     *
     */
    @Override
    public void run() {
     ...
     * @param postion position to add the value at (-1 if there is no position
     * specified
